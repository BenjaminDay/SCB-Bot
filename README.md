This project is primarily to create a bot that can interact with an android emulator (Nox in this case) and remove the need for human interaction on repetitive tasks.
